...
#define STRING_CONFIG_H_AUTHOR "(kamitchell, Ender-3 Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 Pro (kam)"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -7, -2.85 }
